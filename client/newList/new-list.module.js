...
var new_list_component_1 = require("./new-list.component");
...
NewListModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [new_list_component_1.NewListComponent],
        bootstrap: [new_list_component_1.NewListComponent]
    })
], NewListModule);
exports.NewListModule = NewListModule;
